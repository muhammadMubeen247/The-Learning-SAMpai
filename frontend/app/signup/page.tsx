  ...
  return (
    ...
    <main className="relative min-h-[100dvh] w-full overflow-hidden flex items-center justify-center px-4">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(60% 50% at 50% 10%, color-mix(in oklch, var(--color-chart-2) 16%, transparent) 0%, transparent 60%), radial-gradient(40% 40% at 20% 80%, color-mix(in oklch, var(--color-chart-1) 14%, transparent) 0%, transparent 70%)",
        }}
      />
