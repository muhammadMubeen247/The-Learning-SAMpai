...
NOW USING: LangChain OpenAI Embeddings wrapper
"""
...
class VectorStore:
    ...
    NOW USING: LangChain OpenAI Embeddings
    """
    
    def __init__(self):
        """Initialize ChromaDB client and LangChain embeddings"""
        ...
        # NEW: Initialize LangChain OpenAI Embeddings
        ...
        logger.info(f"Using LangChain OpenAI Embeddings: {EMBEDDING_MODEL}")
    ...
    def generate_embeddings_batch(self, texts: List[str]) -> List[List[float]]:
        ...
        """
        try:
            # NEW: Use LangChain batch embeddings
            embeddings = self.embeddings.embed_documents(texts)
            
            logger.info(f"Generated {len(embeddings)} embeddings using LangChain")
            return embeddings
    ...
    def add_document_chunks(
        ...
        try:
            ...
            # Generate embeddings using LangChain (batch)
            logger.info(f"[LangChain] Generating embeddings for {len(chunks)} chunks...")
